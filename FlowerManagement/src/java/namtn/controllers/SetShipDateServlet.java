 ...
 * @author ADMIN
 */
public class SetShipDateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session != null) {
                ...
                if (shipDate.after(orderDate)) {
                    OrderDAO.updateShipDate(orderID, shipDate);
                    ...
                    ArrayList<Order> orders = OrderDAO.getAllOrders();
                    request.setAttribute("listOrder", orders);
                    request.setAttribute("mess", "Ship date must after order date!");
                    request.getRequestDispatcher("manageOrders.jsp").forward(request, response);
                }
            }
        } catch (Exception e) {
